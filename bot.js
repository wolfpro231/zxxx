...
const Token = "NTc2Nzc3OTcyMjU4NzAxMzQw.XNbcsQ.LJeEOjC8rwSujnTmV5TaPiX9esY" //هنا توكن البوت اللي بتشغل عليه الهاك
const x_x = ".2" //هنا تحط الامر اللي يشغل الهاك
const teext = "Hacked By wolf" //هنا تحط وش تبي يكون اسم الرومات الكتابيه
const vooice = "Hacked By wolf" //هنا تحط وش تبي يكون اسم الرومات الصوتيه
...
const spam = "Hacked By wolf" //هنا تحط وش تبي رسالة السبام
const namee = "Hacked By wolf" //هنا تحط وش تبي اسم السيرفر واسم البوت والبلاينق
const playing = "Hacked By wolf" //هنا تحط وش تبي يكون الستريمنق
